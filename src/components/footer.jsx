...
const Footer = () => {
  ...
  {  /* large screen */  }
   ...
   <div className=" md:hidden flex flex-col  px-[32px] py-[48px] text-[#FEFEFE] bg-[#232627] w-screen h-[609px]">
    ...
    <div className='w-auto px-[24px] py-[28px] flex flex-col  h-[172px]  border-[#6C7275] border-t-[0.15px] justify-center items-center'>
   ...
   <div className='h-[68px]  py-[4px] justify-center items-center flex flex-col'>
    ...
    <div className="h-[20px]  text-[12px] w-[81px] font-600 text-[#FEFEFE]">
      OUR POLICIES
      </div>
      <div className="h-[20px]  text-[12px] w-[83px] font-600 text-[#FEFEFE]">
      TERMS OF USE
      </div>
    </div>
    <div className="h-[22px] text-[12px]  pt-[24px] font-400 font-poppins w-[218px] text-[#E8ECEF]">
      Copyright © 2024 All rights reserved
      </div>
   </div>
        </div>
